...
def _load_json_metafeatures_from_directory(metafeatureDirectory, datasetNames):
    ...
    for dataset in np.unique(datasetNames):
        ...
        if os.path.exists(mfPath):
            ...
            logger.warning(f"Couldn't find metafeature file for dataset "
                    f"'{dataset}'")
